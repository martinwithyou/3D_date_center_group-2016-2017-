...
<script>
  import CTaskcollection from 'modules/page3/components/Task_collection'
  import CTaskmonitoring from 'modules/page3/components/Task_monitoring'
  import CTodo from 'modules/page3/components/To_do'
