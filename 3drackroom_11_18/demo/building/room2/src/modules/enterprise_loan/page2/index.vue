...
<script>
  import CEnterpriseInformationInput from 'modules/page2/components/Enterprise_information_input'
  import CEnterpriseInformationInquiry from 'modules/page2/components/Enterprise_information_inquiry'
  export default {
  	components:{
