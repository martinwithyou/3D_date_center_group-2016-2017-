<style scoped>  
  ...
  .nav-main a:hover {
    background-color: rgba(217, 222, 228, 0.5);
    color: #387AB7;
  }
...
<template>
    ...
    <div class="sidebar-scroll">
      <div class="sidebar-content">
        <div class="side-content">
          <ul class="nav-main">
              <li class="nav-main-heading sidebar-title" @click="partShow_a">
                <span class="sidebar-mini-hide" v-text="title_1"></span>
              </li>
              <li class="nav-main-heading sidebar-title"  @click="partShow_b">
                <span class="sidebar-mini-hide" v-text="title_2"></span>
              </li>
              <li class="nav-main-heading sidebar-title"  @click="partShow_c">
                <span class="sidebar-mini-hide" v-text="title_3"></span>
              </li>
          </ul>
        </div>
      </div>
    ...
    <!---------------------------------------------------------------->
    <main class="main-container" v-show="part_a">
    	<c-todo></c-todo>
    </main>
    
    <main class="main-container" v-show="part_b">
    	<c-taskcollection></c-taskcollection>
    </main>
    
    <main class="main-container" v-show="part_c">
    	<c-taskmonitoring></c-taskmonitoring>
    </main>
    <!---------------------------------------------------------------->
  </div>
</template>
...
<script>
  import CTaskcollection from 'modules/page1/components/Task_collection'
  import CTaskmonitoring from 'modules/page1/components/Task_monitoring'
  import CTodo from 'modules/page1/components/To_do'
