...
<script>
	import CTodo from 'modules/page6/components/To_do'
  import CTaskcollection from 'modules/page6/components/Task_collection'
  import CTaskmonitoring from 'modules/page6/components/Task_monitoring'
  export default {
  	components:{
  		CTodo,
  		CTaskcollection,
