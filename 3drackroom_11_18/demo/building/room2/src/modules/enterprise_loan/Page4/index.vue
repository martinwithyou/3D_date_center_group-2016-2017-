...
<template>
    ...
    <main class="main-container" v-show="part_a">
    	<c-enterpriseInformationInput></c-enterpriseInformationInput>
    </main>
    
    <main class="main-container" v-show="part_b">
    	<c-enterpriseInformationInquiry></c-enterpriseInformationInquiry>
    </main>
    <!---------------------------------------------------------------->
  </div>
</template>
...
<script>
  import CEnterpriseInformationInput from 'modules/page4/components/Enterprise_information_input'
  import CEnterpriseInformationInquiry from 'modules/page4/components/Enterprise_information_inquiry'
  export default {
  	components:{
  		CEnterpriseInformationInput,
  		CEnterpriseInformationInquiry
  	},
    data() {
      return {
      	title_1:"企业信息录入",
