...
<!----------------------------->
        ...
        <div style="margin-top:0px">
              ...
              <el-input placeholder="请输入内容" v-model="criteria"></el-input> 
              <el-button @click="search_"></el-button>
              <!--<el-button slot="append" icon="search" v-on:click="search_"></el-button>-->
  ...
  export default {
    data() {
      ...
      return {
        ...
        //请求的URL
        url:'http://192.168.1.110:8080/page',
...
//*****************************************************************************
    ...
    //*********************************************************************************************************
                //从服务器读取数据
                loadData_c: function(criteria, pageNum, pageSize){   
                	//*****************************************
                	console.log(this.url);
                	//*****************************************
                    this.$http.get(this.url,{'params':this.criteria, pageNum:this.currentPage, pageSize:this.pagesize}).then(function(res){
                    	
                    	console.log({params:this.criteria, pageNum:this.currentPage, pageSize:this.pagesize});
                ...
                //************************************************************************************************
                loadData_a: function(criteria,pageNum, pageSize){
                	
                   this.$http({
                    method:'GET',
                   // url:this.url+'?pageNum=1',
                    url:this.url,
                    
                   // params:this.pageNum,
                    body:{params:this.criteria, pageNum:this.currentPage, pageSize:this.pagesize},
...
loadData: function(criteria,pageNum, pageSize){
 //*****************************************************************************************
                  // POST /someUrl
  this.$http.post(this.url, {params:this.criteria, pageNum:this.currentPage, pageSize:this.pagesize},{emulateJSON:true}).then(response => {
